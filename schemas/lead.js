...
export const Leads = defineType({
  name: 'leads_meta_global_leads',
  title: 'Leads-Meta Global Leads',
  type: 'document',
  fields: [
    ...
    defineField({ name: 'creation_date', title: 'Creation Date', type: 'datetime' }),
    defineField({ name: 'first_call_attempt', title: 'First Call Attempt', type: 'datetime' }),
    ...
    defineField({ name: 'last_call_date', title: 'Last Call Date', type: 'datetime' }),
    defineField({ name: 'last_call_time', title: 'Last Call Time', type: 'datetime' }),
    defineField({ name: 'next_followup_date', title: 'Next Followup Date', type: 'datetime' }),
    ...
    defineField({
      ...
      fields: [
        ...
        defineField({ name: 'utm_content', title: 'UTM Content', type: 'string' }),
    ...
    defineField({ name: 'lead_closed_by_executive', title: 'Lead Closed By Executive', type: 'string' }),
    defineField({ name: 'lead_closed_reason', title: 'Lead Closed Reason', type: 'string' }),
    defineField({ name: 'call_attempt_count', title: 'Call Attempt Count', type: 'number' }),
  ]
});
